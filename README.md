...
It can optionally email when new errors are detected
...
/usr/sbin/curl --retry 3 "https://raw.githubusercontent.com/JGrana01/mtdmon/master/mtdmon.sh" -o "/jffs/scripts/mtdmon.sh" && chmod 0755 /jffs/scripts/mtdmon.sh && /jffs/scripts/mtdmon.sh install
